...
def main(
    ...
    batch_size = 16
    num_epochs = 1
    # image_size = 32,64,96,128,160,192,224,256,288,320,352,384
    # image_size = 256  # We'll resize input images to this size
    patch_size = 16  # Size of the patches to be extract from the input images

    # image_size = 224  # We'll resize input images to this size
    # patch_size = 16  # Size of the patches to be extract from the input images
    # sequence_len = num_patches = (image_size // patch_size) ** 2
    # model_dimension = projection_dim
    # so the memory bottlenect is batch_size * num_patches*num_patches 
    # (72/6)^2 = 144 32*144*144*
    projection_dim = 32
    num_heads =12
    # num_heads =4
    transformer_units = [
    ...
    if dump_name != "none":
        ...
        # image_size_list = [224,256,288,320,352,384,400]
    else:
